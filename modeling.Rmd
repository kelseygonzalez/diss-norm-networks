...
of contagion and assortativity, signals, community integration, and other
...
### Assortativity and Behavioral Reinforcement: 
...
counties. I will then develop an _assortativity_ coefficient for each county to
...
measure used in research on homophily, in this case a low assortativity
...
While _assortativity_ is important to measure the reinforcement of movement
...
assortativity coefficient) to stay at home (positive dependent variable) or may
be reinforced (high assortativity coefficient) to remain as normal (near zero or
...
$$
\begin{aligned}
inresidence_{it} = assortativity_{it}\beta_{1}+signaldirection_{it}\beta_{2}+ \\
... coronacases_{it}\beta_{3}+assort\times signal_{it}\beta_{4}+x_{it}\beta_{5}...+u_{0i}+\epsilon_{it}
\end{aligned}
$$
