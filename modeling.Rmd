...
place and that form in response to the policy. 
<!-- TODO: discuss norms, how it's hard to diverge from current norms, habitus  -->
...
```
<!-- TODO integrate or get rid of norm framework -->
...
pandemic. This means that the population mobility
...
<!-- TODO choose whether the dage is necessary and place it in a better spot and integrate it -->
...
propensity to test <!-- (TODO CITE, I asked Simone).  --> However, it is the best measure we have of
actual case rates. County data are scaled with a rolling mean with a rolling
window width of seven days to smooth out intra-week noise. Case Rate is measured
...
effect for the interaction between signal and discordance; Figures \@ref(fig:plot-google-h3) and \@ref(fig:plot-vacc-h3)
...
<!-- finished double checking below  -->
